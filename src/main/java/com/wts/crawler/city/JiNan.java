...
public class JiNan {
     ...
     * bzlx：编制类型
     */
    public static void downPersonList(String baseURL, String szcs, String dwzd, String dwlb, String dwlx, String sjdw, String dwbh, String dwmc, String bzlx) {
        try {
            ...
            personErr.set("szcs", szcs).set("dwzd", dwzd).set("dwlb", dwlb).set("dwlx", dwlx).set("dwbh", dwbh).set("sjdw", sjdw).set("dwmc", dwmc).set("bzlx", bzlx).set("base", baseURL).save();
        }
    }
